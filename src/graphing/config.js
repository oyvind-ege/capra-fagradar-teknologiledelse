...
const getQuadrants = () => {
  return JSON.parse(process.env.QUADRANTS || null) || ['Teamkompetanse', 'Organisasjonskompetanse', 'Teknisk kompetanse', 'Sosial kompetanse']
}

const getRings = () => {
  return JSON.parse(process.env.RINGS || null) || ['Grunnmur', 'Bruk', 'Vurder', 'Avstå']
}
